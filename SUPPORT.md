...
`foundry-sample-insider-risk-sailpoint` is a community-driven, open source project which serves as an example of an app which can be built using CrowdStrike's Foundry ecosystem.
...
Issues may be reported [here](https://github.com/CrowdStrike/foundry-sample-insider-risk-sailpoint/issues/new/choose) and are used to track bugs, documentation and link updates, enhancement requests and security concerns.
...
### [Report an Issue →](https://github.com/CrowdStrike/foundry-sample-insider-risk-sailpoint/issues/new/choose)
